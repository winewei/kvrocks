...
Config::Config() {
  ...
  FieldWrapper fields[] = {
      ...
      {"hash-inline-enabled", false, new YesNoField(&hash_inline_enabled, false)},
      {"hash-inline-max-fields", false, new IntField(&hash_inline_max_fields, 8, 1, 4096)},
      {"hash-inline-max-bytes", false, new IntField(&hash_inline_max_bytes, 512, 1, 64 * 1024)},
      ...
      {"rocksdb.metadata_block_size", true, new IntField(&rocks_db.metadata_block_size, 0, 0, INT_MAX)},
      ...
      {"rocksdb.share_block_cache_for_aux_column_families", true,
       new YesNoField(&rocks_db.share_block_cache_for_aux_column_families, false)},
      ...
      {"rocksdb.bytes_per_sync", true, new UInt64Field(&rocks_db.bytes_per_sync, 0, 0, UINT64_MAX)},
      {"rocksdb.wal_bytes_per_sync", true, new UInt64Field(&rocks_db.wal_bytes_per_sync, 0, 0, UINT64_MAX)},
